...
public class JiraIssueCreator implements ServerExtension {
  ...
  public RemoteIssue createIssue(Issue sonarIssue, Settings settings, String comments) throws RemoteException {
    JiraSoapSession soapSession = createSoapSession(settings);

    return doCreateIssue(sonarIssue, soapSession, settings, comments);
  }
